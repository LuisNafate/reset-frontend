    ...
    return (
      <div className="min-h-full flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-[10px] text-slate-400 tracking-[1px] uppercase" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Cargando mensajes...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-full">
      <div className="max-w-2xl mx-auto px-4 sm:px-10 py-8 sm:py-12">
        ...
        {sendDisabled && (
          <div className="border border-amber-100 bg-amber-50 rounded-sm px-5 py-3 mb-6 flex items-start gap-3">
            ...
            <p className="text-[11px] italic text-amber-700 leading-relaxed" style={{ fontFamily: "'Playfair Display', serif" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[1fr_220px] gap-5">
          ...
          <div className="flex flex-col gap-4">
            <div className="border border-slate-200 bg-white rounded-sm p-6 flex flex-col gap-3 min-h-[320px]">
              {messages.length === 0 ? (
                <div className="flex-1 flex flex-col items-center justify-center text-center gap-3 py-10">
                  ...
                  <p className="text-[12px] italic text-slate-400" style={{ fontFamily: "'Playfair Display', serif" }}>
                    Aún no hay mensajes.
                  </p>
                  <p className="text-[10px] text-slate-300 leading-relaxed max-w-[180px]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
            ...
            {/* Error de envío */}
            {error && (
              <p className="text-[10px] text-red-400 px-1" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                {error}
              </p>
            )}
            ...
            <div className="flex gap-2">
              <textarea
                ...
                className="flex-1 border border-slate-200 rounded-lg px-4 py-3 text-slate-700 text-[13px] outline-none resize-none focus:border-teal-300 focus:ring-1 focus:ring-teal-100 transition-all disabled:bg-slate-50 disabled:text-slate-300 disabled:cursor-not-allowed"
